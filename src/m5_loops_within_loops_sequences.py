...
def run_test_integers():
    ...
    # Test 2:
    expected = [1, 2, 4, 5, 100, 0, 12, 25, 33, 4, 30, -3]
    answer = integers([(1, 2, 4, 5),
                       (100, 'bye', 0),
                       [12, 25, 33, 4],
                       'welcome',
                       [],
...
def run_test_big_letters():
    ...
    # Test 2:
    expected = 'DOYOUHAVENPIIODDSAOPSAPSBOSCOPDOO'
    answer = big_letters([(2, 7, 8),  # not a string
                          'DO YOU HAVE None',  # DOYOUHAVEN
                          (1, 'Ok what is ThiSSS?', 140),  # not a string
                          [],  # not a string
                          ['oopsa;osdfij;a'],  # not a string
                          'oopsaldkdjjPII',  #PII
                          ['OOPSdkjPPOS'],  # not a string
                          '1 ODDSAOPS !',  # ODDSAOPS
                          'A',  # A
                          'ooPS $$&*#%&&',  # PS
                          'B',  # B
